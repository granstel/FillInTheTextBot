...
namespace FillInTheTextBot.Services.Tests
{
    ...
    public class StoryComputationsTests
    {
        ...
        public void TryBuildContext_MidSummer_FillsContext()
        {
            ...
            ClassicAssert.True(result);
            ClassicAssert.AreEqual("summer-days", context.Name);
            ClassicAssert.AreEqual(2, context.LifeSpan);
            ClassicAssert.AreEqual("90", context.Parameters["daysLeft"]);
        }
        ...
        public void TryBuildContext_SeasonStart_May29_FillsContext()
        {
            ...
            ClassicAssert.True(result);
            ClassicAssert.AreEqual("93", context.Parameters["daysLeft"]);
        }
        ...
        public void TryBuildContext_DayBeforeEnd_One()
        {
            ...
            ClassicAssert.True(result);
            ClassicAssert.AreEqual("1", context.Parameters["daysLeft"]);
        }
